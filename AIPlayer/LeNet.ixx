...
namespace LeNet
{
    ...
    void LenetForward_v_10()
    {
        ...
        NeuralNetwork nn(batchSize, dims.size(), dims.data(), NeuralNetwork::VERBOSITY::MAX);
        ...
        nn.addConvBiasAct(5, 120, 0, true, "FC5");
        nn.addConvBiasAct(1, 84, 0, true, "FC6");
        nn.addConvBiasAct(1, 10, 0, true, "FC7");
        nn.addSoftmax(true);
        nn.addCrossEntropy(true);
